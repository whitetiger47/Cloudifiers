// {
//   "email": "viren2malavia42@gmail.com",
//   "password": "Cloudifiers@123"
// }
...
const Login = () => {
  ...
  const onSubmit = (data) => {
    // console.log(data);
    // const { email="viren2malavia42@gmail.com", password="Cloudifiers@123" } = data;
    ...
    axios_api
      .post("/login", loginCredentials).then((response) => {
        if (response.data.success) {
          // const { data } = response;
          // console.log("data: " + data);
          // console.log("response.data.user.userId: " + response.data.user.userId);
          ...
          console.log("Logged in user stored: " + localStorage.getItem("userId"));
