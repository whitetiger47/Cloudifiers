...
//   furnished: yup.boolean().required("Field is required"),

//   bedrooms: yup.string().required("Bedroom information is required."),

//   bathrooms: yup.string().required("bathroom infromation is required."),
